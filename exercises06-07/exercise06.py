...
# 
# Build three binary vectors (with values ± 1) of 10 elements. Each of them represents a possible input pattern. Normalize the vectors so that each of them has unitary norm and arrange them along three columns of an X matrix. Consider a hetero-associative network with 10 inputs and 3 output neurons. The output neurons have activation values between 0 and 1.
# 
