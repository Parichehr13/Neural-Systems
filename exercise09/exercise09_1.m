...
% elimino una data percentuale di sinapsi
diluizione = 0.995;
Sinapsi_danneggiate = (rand(N,N) > diluizione);   % matrice che assume valore 0 solo con percentiuale pari a diluizione
W = W.*Sinapsi_danneggiate;
